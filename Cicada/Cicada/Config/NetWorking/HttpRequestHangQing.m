...
//#import "HangQingHomeCViewController.h"
//#import "HangQingHomeNextViewController.h"
//#import "IndexViewController.h"
//#import "SectionViewController.h"
//#import "NewSharesViewController.h"
//#import "SearchViewController.h"




@interface HttpRequestHangQing ()
...
@implementation HttpRequestHangQing

//创建单利
+ (instancetype)getInstance {
    static HttpRequestHangQing *managerRe;
...
//        managerRe.manager.requestSerializer.timeoutInterval = 60.f;
...
//        _manager.requestSerializer.timeoutInterval = REQUEST_TIMEOUT_INTERVAL;
        ...
        sessionTask = [_manager GET:URLString parameters:parameters progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
            ...
            if (failure) {
                //                if ([ToolHelper internetReachability] == 1) {
                //                    error = [NSError errorWithDomain:@"PanGuHttpErrorDomain" code:NetworkErrorCode userInfo:nil];
                //                }
                _response = (NSHTTPURLResponse *)task.response;
                failure(error,task);
            }
...
//        [_manager.requestSerializer setValue:K_VERSION_SHORT forHTTPHeaderField:@"VersionNum"];
        [_manager.requestSerializer setValue:@"iOS" forHTTPHeaderField:@"AppType"];
        //进行下载Post请求
...
//取消请求
+ (void)cancel {
    NSLog(@"manager.operationQueue.operationCount == %zd", [HttpRequestHangQing getInstance].manager.operationQueue.operationCount);
    NSArray *arr = [[HttpRequestHangQing getInstance].manager dataTasks];
